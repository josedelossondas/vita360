...
export function LayoutPatrullero() {
    const { user, logout, token } = useAuth();
    const navigate = useNavigate();

    if (!user || user.role !== "patrullero_municipal") {
            ...
            <header style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div>
                        ...
                        <div style={{ fontSize: 10, color: '#94a3b8', marginTop: 2 }}>Patrullero Municipal</div>
                    </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{
                        ...
                        background: 'rgba(184,44,135,0.06)', border: '1px solid rgba(184,44,135,0.15)',
                        fontSize: 12, fontWeight: 600, color: '#b82c87',
                    }}>
                        <Shield size={13} />
                        <span style={{
